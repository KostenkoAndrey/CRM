...
import InputField from '@/app/сomponents/input-field';
import LogoUploader from '@/app/сomponents/logo-uploader';
import StatusLabel from '@/app/сomponents/status-label';
...
export default function CompanyForm({ onSubmit }: CompanyFormProps) {
  ...
  const handleSubmit = async (values: CompanyFieldValues) => {
    if (!categories || !countries) {
      console.error('Categories or countries not loaded');
      return;
    }
    await mutateAsync({
      ...values,
